...
// Check local storage for best score, set best score value
...
// Add a tenth of the second to timePlayed
function addTime() {
  timePlayed += 0.1;
  checkTime();
}
...
// Get a random number up to a max
...
startForm.addEventListener("click", () => {
  radioContainers.forEach((radioEl) => {
    ...
    // Add it back if radio is selected
